...
2. run the `setup.main.kts`script located in the project root and pass in the name of the new project you would like to create
...
4. On github under settings -> developer settings -> personal access tokens, create a fine grained
...
5. On github under project -> settings -> actions -> general, set the Workflow permissions to be read & write
